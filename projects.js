window.PORTFOLIO_FEATURED = [
  {
    ...
    kicker: "Mobile app",
    summary: "A live profile and nutrition-target flow with local persistence.",
  ...
  },
  {
    ...
    kicker: "Browser game",
    summary: "A playable reward loop with upgrades and a mobile-friendly entry point.",
  ...
  },
  {
    ...
    kicker: "Automation",
    summary: "A queue-based worker for voice, subtitles, ffmpeg rendering and outputs.",
    image: "assets/video-worker-pipeline.svg",
    links: [
      { label: "Code", url: "https://github.com/KaimiEwl/ai-video-render-worker", primary: true }
    ]
  }
];
